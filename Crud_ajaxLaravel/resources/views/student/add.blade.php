...
<div class="modal fade" id="modal-add">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="{{ route('add') }}" data-url="{{ route('add') }}" id="form-add" method="POST" role="form">
				@csrf
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input name="ngaysinh" type="date" name="" id="ngaysinh-add" class="form-control" value=""  title="">
					</div>
